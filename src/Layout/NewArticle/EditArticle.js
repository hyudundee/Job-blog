...
class EditArticle extends Component {
    ...
    componentDidMount() {
        var info = this.props.location.state.article
        this.setState({
            article: {
                ...this.state.article,
                title: info.title,
                ...
                <Row>
                    <Col xl={9} lg={9} md={8} sm={12} xs={12}>
                        ...
                        <FormGroup>
                            ...
                            <Input type='text' name='articleTitle' od='articleTitle'
                            ...
                            <CardBody>
                                <FormGroup>
                                    ...
                                    <Input type='select' name='jobtype' id='jobtype'
                                           ...
                                           value={this.state.article.jobtype}
                                    >
                                        <option> </option>
                                ...
                                <FormGroup>
                                    ...
                                    <Input type='text' name='company' id='company'
                                        value={this.state.article.company}
